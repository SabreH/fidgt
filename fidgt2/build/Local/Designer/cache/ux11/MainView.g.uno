...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("light", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::LightPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    public partial class Template3: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template3(MainView parent, MainView parentInstance): base("friend", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::FriendPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "friend";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template4: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template4(MainView parent, MainView parentInstance): base("sketch", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::SketchPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    public partial class Template5: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template5(MainView parent, MainView parentInstance): base("animation", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::AnimationPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "animation";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template6: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template6(MainView parent, MainView parentInstance): base("counter", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        static global::Uno.UX.Selector __selector0 = "counter";
    }
    ...
    void InitializeUX()
    {
        ...
        var light = new Template2(this, this);
        var friend = new Template3(this, this);
        var sketch = new Template4(this, this);
        var animation = new Template5(this, this);
        var counter = new Template6(this, this);
        router.Name = __selector0;
        temp17.DefaultPath = "splash";
        temp17.Templates.Add(splash);
        temp17.Templates.Add(home);
        temp17.Templates.Add(light);
        temp17.Templates.Add(friend);
        temp17.Templates.Add(sketch);
        temp17.Templates.Add(animation);
        temp17.Templates.Add(counter);
